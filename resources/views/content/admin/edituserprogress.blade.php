...
<div id="content" class="container-fluid p-4 p-md-5 pt-5">
    <div class="row">
        <div class="col-12">
            ...
            <h6 class="text-secondary ml-5 mb-4">Silahkan isi dengan data baru!</h6>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="p-3 py-5">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="text-right text-me fw-bold">Formulir edit data</h4>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-12"><label class="labels fw-bold">Nama</label><input
                                        ...
                                        placeholder="" value="{{ $users->name }}" required>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-12"><label class="labels fw-bold">Email</label><input
                                        ...
                                        placeholder="" value="{{ $users->email }}" required>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="mt-5 text-center"><button class="btn btn-me text-light" type="submit"><span class="fas fa-pencil"></span> Edit</button><a href="/dashboard"><button class="btn btn-danger ml-3 text-light" type="button"><span class="fas fa-ban"></span> Batal</button></a></div>
        </form>
