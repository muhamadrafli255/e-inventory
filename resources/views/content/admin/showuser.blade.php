...
<div class="card bg-tb">
    <div class="card-body table-responsive">
        ...
        <a href="/user/tambah"><button class="btn btn-me text-light mt-3 mb-3"><span class="fas fa-plus-circle"></span> Tambah Data</button></a>
        <table id="myTable" class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><button class="btn btn-success" type="submit" data-bs-toggle="modal" data-bs-target="#modalDetail{{ $user->id }}"><span class="fas fa-eye"></span></button><br>
                  <a href="/user/edit/{{ $user->id }}" class="btn btn-me mt-2 text-light"><span class="fas fa-pencil"></span></a><br>
                  <button class="btn btn-danger mt-2" type="button" data-bs-toggle="modal" data-bs-target="#modalDelete{{ $user->id }}"><span class="fas fa-ban"></span></button>
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                               <div class="card ml-7" style="width: 18rem;">
                                ...
                                @endif
                                    <div class="card-body">
                                        <h5 class="card-title">Nama : <h6 class="fw-bold">{{ $user->name }}</h6><hr></h5>
                                            <h5 class="card-text mb-3">Email : <h6 class="fw-bold">{{ $user->email }}</h6></h5><hr>
                                            <h5 class="card-text mb-3">Kelas : <h6 class="fw-bold"></h6>{{ $user->userclass->class_name }}</h5><hr>
                                          </div>
                                        </div>
                                      </div>
                               ...
                               <div class="card ml-7" style="width: 18rem;">
                                ...
                                @endif
                                    <div class="card-body">
                                        <h5 class="card-title">Nama : <h6 class="fw-bold">{{ $user->name }}</h6><hr></h5>
                                            <h5 class="card-text mb-3">Email : <h6 class="fw-bold">{{ $user->email }}</h6></h5><hr>
                                            <h5 class="card-text mb-3">Kelas : <h6 class="fw-bold">{{ $user->userclass->class_name }}</h6></h5><hr>
                                          </div>
                                        </div>
                                      </div>
                                    <div class="modal-footer">
