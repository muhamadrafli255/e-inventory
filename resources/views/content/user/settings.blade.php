...
<form action="/updateakunuser/{{ auth()->user()->id }}" method="POST" enctype="multipart/form-data">
    @method('put')
    @csrf
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                ...
                <img class="border border-primary img-thumbnail" width="150px" src="https://icon-library.com/images/user-icon-vector/user-icon-vector-26.jpg">
                @else   
        ...
        <div class="col-md-12">
            <div class="p-3 py-5">
                ...
                <div class="mt-3 text-center"><a href="/pengaturanpassworduser/{{ auth()->user()->id }}"><button class="btn btn-me text-light" type="button"><span class="fas fa-lock"></span> Pengaturan Password</button></a></div>
            </div>
        </div>
    </div>
</div>
